(function ($) {
  ...
  $(function () {
    ...
    if ($("#earning-line-chart").length) {
      var lineChartData = {
        labels: ["Dec", "Jan", "Feb", "March", "Apr", "May", ""],
        datasets: [
          {
            data: [19, 42, 18, 15, 22, 19],
        ...
        datasets: [
          {
            ...
            data: [15000, 10000, 8000, 9000, 12000],
            label: "Expenses",
          },
        ],
      };
    ...
    /********************************* */
    if ($("#student-attendance-chart").length) {
      var doughnutChartData = {
        labels: ["Present", "Absent"],
        datasets: [
          {
            backgroundColor: ["#304ffe", "#ff3801"],
            data: [45, 2],
            label: "Attendance 2020",
          },
        ],
      };
      var doughnutChartOptions = {
      ...
      var studentCanvas = $("#student-attendance-chart")
        .get(0)
        .getContext("2d");
      var studentChart = new Chart(studentCanvas, {
        type: "doughnut",
